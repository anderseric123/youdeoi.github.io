...
MANUAL_OPEC_COUNTRY_ROWS = [
    {"country": "沙特", "target": 10.10, "actual": 10.28},
    {"country": "伊拉克", "target": 4.15, "actual": 4.34},
    {"country": "阿联酋", "target": 3.40, "actual": 3.60},
    {"country": "科威特", "target": 2.58, "actual": 2.57},
    {"country": "哈萨克斯坦", "target": 1.29, "actual": 1.31},
    {"country": "俄罗斯", "target": 9.57, "actual": 9.30},
    {"country": "阿曼", "target": 0.80, "actual": 0.81},
    {"country": "阿尔及利亚", "target": 0.97, "actual": 0.96},
]

MANUAL_OPEC_TREND = [
    {"date": "2025-09", "actual": 36.95, "target": 36.04},
    {"date": "2025-10", "actual": 36.74, "target": 36.28},
    {"date": "2025-11", "actual": 36.23, "target": 36.38},
    {"date": "2025-12", "actual": 36.19, "target": 36.47},
    {"date": "2026-01", "actual": 36.33, "target": 36.32},
]
        ...
        "sources": [
            {
                ...
                "url": EIA_STEO_XLSX_URL,
                "note": "全球原油供需平衡月度表。",
            },
            {
                "name": "EIA Weekly Petroleum Status Report history",
                "url": "https://www.eia.gov/petroleum/supply/weekly/",
                "note": "美国商业库存、库欣库存、汽油库存、馏分油库存与炼厂开工周度历史。",
            },
            {
                "name": "FRED WTI spot price",
                "url": FRED_WTI_URL,
                "note": "用于浮仓图表与裂解价差的 WTI 现货对照轴。",
            },
            {
                "name": "FRED NYH gasoline and diesel spot prices",
                "url": "https://fred.stlouisfed.org/",
                "note": "汽油 / 柴油裂解价差的日度现货口径代理。",
            },
            {
                "name": "Investing.com continuous WTI futures history",
                "url": "https://www.investing.com/commodities/crude-oil-historical-data",
                "note": "WTI 近月与次月连续合约历史页，用于月差序列。",
            },
            {
                "name": "IEA Oil Market Report",
                "url": "https://www.iea.org/reports/oil-market-report-february-2026",
                "note": "OPEC+ 实际产量、目标产量与执行率口径，当前手工整理至 2026-01。",
            },
        ],
